...
<div class="mb-6 text-center">
  ...
  <p class="text-gray-500 text-sm mt-1">Rejoignez KivuBoost et boostez vos réseaux</p>
</div>
...
<div class="relative my-5">
  ...
  <div class="relative flex justify-center">
    <span class="px-3 text-xs text-gray-600 font-medium" style="background:#0d1117">ou s'inscrire avec</span>
  </div>
</div>
